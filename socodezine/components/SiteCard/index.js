...
const App = props => {
    ...
    <div className={styles.contentItems}><h3>{app.name}</h3>
            ...
            <footer className={styles.contentItems}> 
                ...
                <span className={styles.react}>react
                </span>
                <span className={styles.react}>node.js
                </span>
                <span className={styles.react}>express
                </span>
                </div>
                </div>
       </footer>
